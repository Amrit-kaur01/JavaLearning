...
public class Iterate {
    public static void main(String[] args) {
        ...
        //Fibonacci series 
        List<Integer> fibSeries = Stream.iterate(new int[]{0,1}, n -> new int[]{n[1], n[0]+n[1]})
                                        .limit(10)
                                        .map(n -> n[0])
        ...
        int sum = Stream.iterate(new int[]{0,1}, n -> new int[]{n[1], n[0]+n[1]})
                        .limit(10)   // limit is short-circuiting intermediate operation
...
/*
 *an intermediate operation is short-circuiting if, when presented with infinite input, it gives a finite stream as a result
