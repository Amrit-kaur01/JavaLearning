...
public class BasicOperations {
    public static void main(String[] args) {
         ...
         * for every  element, a separate hash is generated internally
         */
        map.put(1, 'A');
        map.put(2,'B');
        map.put(3, 'C');
        ...
        //Removing elements 
        //We will pass the key value in the remove() method to eliminate the associated value
        map.remove(4);
        ...
        //Changing elements 
        //we can change the already added elements using the same put() method. we have to pass the same key again
        map.put(5, 'e');
        ...
        System.out.println(map.containsKey(1)); //returns a boolean value depending on whether the specified key is mapped or not
...
/*
 * Standard examples of using map includes:
 * map of cities and and their zip codes
 * map of employees and their managers
 * map of errors and their descriptions
 */